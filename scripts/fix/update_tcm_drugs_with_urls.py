...
# 23个中成药及其网址
TCM_DRUGS_URLS = {
    371: {'name': '湿润烧伤膏', 'url': 'https://www.hnysfww.com/goods.php?id=7668'},
    383: {'name': '康复新液', 'url': 'https://www.hnysfww.com/goods.php?id=7640'},
    389: {'name': '天丹通络', 'url': 'https://www.hnysfww.com/goods.php?id=5263'},
    390: {'name': '天舒', 'url': 'https://www.hnysfww.com/goods.php?id=7249'},
    472: {'name': '六味地黄', 'url': 'https://www.hnysfww.com/goods.php?id=6577'},
    487: {'name': '※▲※▲清开灵', 'url': 'https://www.hnysfww.com/goods.php?id=7425'},
    488: {'name': '脉络宁口服液', 'url': 'https://www.hnysfww.com/goods.php?id=5198'},
    502: {'name': '白脉', 'url': 'https://www.hnysfww.com/goods.php?id=4813'},
    524: {'name': '※▲连榆烧伤膏', 'url': 'https://www.hnysfww.com/goods.php?id=13325'},
    526: {'name': '※▲香丹', 'url': 'https://www.hnysfww.com/goods.php?id=5353'},
    626: {'name': '解郁除烦', 'url': 'https://www.hnysfww.com/goods.php?id=13383'},
    874: {'name': '活血止痛膏', 'url': 'https://www.hnysfww.com/goods.php?id=5695'},
    882: {'name': '西帕依固龈液', 'url': 'https://www.hnysfww.com/goods.php?id=4000'},
    883: {'name': '复方阿胶浆', 'url': 'https://www.hnysfww.com/goods.php?id=6435'},
    885: {'name': '牛黄清心', 'url': 'https://www.hnysfww.com/goods.php?id=7181'},
    918: {'name': '胆宁', 'url': 'https://www.hnysfww.com/goods.php?id=4417'},
    927: {'name': '※▲儿茶上清', 'url': 'https://www.hnysfww.com/goods.php?id=13746'},
    933: {'name': '华佗再造', 'url': 'https://www.hnysfww.com/goods.php?id=7293'},
    968: {'name': '金匮肾气', 'url': 'https://www.hnysfww.com/goods.php?id=6502'},
    1010: {'name': '祛风骨痛凝胶膏', 'url': 'https://www.hnysfww.com/goods.php?id=13041'},
    1015: {'name': '筋骨伤', 'url': 'https://www.hnysfww.com/goods.php?id=8206'},
    1021: {'name': '大川芎口服液', 'url': 'https://www.hnysfww.com/goods.php?id=7244'},
    1032: {'name': '桂林西瓜霜', 'url': 'https://www.hnysfww.com/goods.php?id=4139'},
}
...
def update_tcm_drugs():
    ...
    for drug_id, drug_info in TCM_DRUGS_URLS.items():
        ...
        try:
            ...
            drug_data['url']['last_updated'] = '2026-03-21'
    ...
    print(f"\n{'=' * 80}")
    print(f"处理完成: 成功 {updated_count}/{len(TCM_DRUGS_URLS)}")
